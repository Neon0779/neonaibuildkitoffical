    ...
    <main className="page">
      ...
      <section className="cta">
        <div>
          ...
          <p>
            Start the NEON AI guided Android assistant build workflow.
          </p>
        </div>
      ...
      <style jsx>{`
        * {
        ...
        nav {
          ...
          border-bottom:
            1px solid rgba(121, 220, 255, 0.12);
        }
        ...
        .offer {
          ...
          border:
            1px solid rgba(61, 220, 255, 0.28);
        ...
        .message {
          ...
          border:
            1px solid rgba(61, 220, 255, 0.22);
